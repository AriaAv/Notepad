...
namespace mynotepad3
{
    ...
    {
        public Boolean fuctionfind(string s)
        {
            int i;
            ...
            public Boolean fuctionfindnext(string s)
        {
            int i;
         ...
         void setenable(){
             findToolStripMenuItem.Enabled = Convert.ToBoolean(txtnotepad.Text.Length);
             copyToolStripMenuItem.Enabled = Convert.ToBoolean(txtnotepad.SelectedText.Length);
            ...
            public Boolean fuctionfindnextup(string s)
            {
                int i;
                i = txtnotepad.Text.LastIndexOf(s, txtnotepad.SelectionStart - 1);
                if (i == -1)
                {
                    MessageBox.Show("not found");
                    return (false);
        ...
        private void txtnotepad_MouseMove(object sender, MouseEventArgs e)
        {
            setenable();
        }
